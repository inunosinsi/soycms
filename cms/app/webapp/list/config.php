...
if(SOYCMS_DB_TYPE == "sqlite"){
	SOY2DAOConfig::Dsn("sqlite:" . CMS_COMMON . "db/list.db");
}else{
...
define("SOY_LIST_IMAGE_UPLOAD_DIR", soy2_realpath($_SERVER["DOCUMENT_ROOT"])."listImage/");
define("SOY_LIST_IMAGE_ACCESS_PATH", "/listImage/");
