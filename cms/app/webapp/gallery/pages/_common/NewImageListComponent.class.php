...
class NewImageListComponent extends HTMLList{
	...
	protected function populateItem($entity){
		...
		if(!isset($imageDir) || !strlen($imageDir)) $imageDir = (is_numeric($entity->getGalleryId())) ? self::_getUploadDirByGalleryId($entity->getGalleryId()) : "";
		...
		$this->addLabel("create_date", array(
			"text" => date("Y/m/d H:i:s", (int)$entity->getCreateDate())
		));
	 ...
	 * @return string
	 */
	private function _getUploadDirByGalleryId(int $galleryId){
		static $dao, $list;
