...
class CheckVersionLogic extends SOY2LogicBase{
	...
	const VERSION_KEY = "SOYCALENDAR_DB_VERSION";
	...
	function getCurrentVersion(){
		return SOYCalendar_DataSets::get(self::VERSION_KEY,0);
	}
	...
	private function setDirectory(){
		if(!defined("SOYCALENDAR_DB_MODE")) define("SOYCALENDAR_DB_MODE", SOYCMS_DB_TYPE);
		$this->directory = SOY2::RootDir() . "logic/upgrade/sql/" . SOYCALENDAR_DB_MODE ."/";
	}
}
