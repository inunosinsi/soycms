...
if(SOYCMS_DB_TYPE == "sqlite"){
	SOY2DAOConfig::Dsn("sqlite:" . CMS_COMMON . "db/voice.db");
}else{
	include_once(CMS_COMMON . "config/db/".SOYCMS_DB_TYPE.".php");
...
define("SOY_VOICE_IMAGE_UPLOAD_DIR", soy2_realpath($_SERVER["DOCUMENT_ROOT"])."voiceImage/");
define("SOY_VOICE_IMAGE_ACCESS_PATH", "/voiceImage/");
