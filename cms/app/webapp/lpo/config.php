...
if(SOYCMS_DB_TYPE == "sqlite"){
	SOY2DAOConfig::Dsn("sqlite:" . CMS_COMMON . "db/lpo.db");
}else{
...
define("SOY_LPO_IMAGE_UPLOAD_DIR", soy2_realpath($_SERVER["DOCUMENT_ROOT"])."lpoImage/");
define("SOY_LPO_IMAGE_ACCESS_PATH", "/lpoImage/");
