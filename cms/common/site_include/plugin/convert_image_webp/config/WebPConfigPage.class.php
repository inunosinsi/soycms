...
class WebPConfigPage extends WebPage {
	...
	function execute(){
		...
		$isCompatibleVersion = function_exists("imagewebp");
		DisplayPlugin::toggle("unusable_webp", !$isCompatibleVersion);
		DisplayPlugin::toggle("usable_webp", $isCompatibleVersion);
