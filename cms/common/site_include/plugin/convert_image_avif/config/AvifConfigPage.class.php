...
class AvifConfigPage extends WebPage {
	...
	function execute(){
		...
		$isCompatibleVersion = function_exists("imageavif");
		DisplayPlugin::toggle("unusable_avif", !$isCompatibleVersion);
		DisplayPlugin::toggle("usable_avif", $isCompatibleVersion);
