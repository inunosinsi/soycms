...
class ImageSelectComponent extends HTMLInput{
	...
	function getWrapperStart(){
		...
		//選択ボタン
		$html[] = '<a class="button" href="javascript:void(0);" onclick="return ImageSelect.popup(\''.$id.'\');">Select</a>';

		//クリアボタン
		$html[] = '<a class="button" href="javascript:void(0);" onclick="return ImageSelect.clear(\''.$id.'\');">Clear</a>';
