 ...
 */
class SOYShopUserSearch implements SOY2PluginAction{

	/**
	 * @return array("queries" => "", "binds" => array())
	 * queriesはサブクエリ形式でSQL構文の配列を返せば良い id IN (SELECT id FROM soyshop_user 〜以下省略〜)
	 */
...
class SOYShopUserSearchDeletageAction implements SOY2PluginDelegateAction{
	...
	function run($extetensionId, $moduleId, SOY2PluginAction $action){
		if($action instanceof SOYShopUserSearch){
...
SOYShopPlugin::registerExtension("soyshop.user.search", "SOYShopUserSearchDeletageAction");
