 ...
 */
class SOYShopItemSearch implements SOY2PluginAction{
	 ...
	 * formの値に挿入するフォームのnameはSearchForm[customs][モジュールID][ユニークなパラメータ]にしなければ動作しない
	 **/
	function searchItems($params){
		return array("label" => "", "form" => "");
	}
}
class SOYShopItemSearchDeletageAction implements SOY2PluginDelegateAction{
	...
	function run($extetensionId, $moduleId, SOY2PluginAction $action){
		if($action instanceof SOYShopItemSearch){
...
SOYShopPlugin::registerExtension("soyshop.item.search", "SOYShopItemSearchDeletageAction");
