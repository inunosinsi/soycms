...
//}
//
//class SearchUserUtil_SortImpl implements SearchUserUtil_Sort{
//
//	private $obj;
//
...
//
//		if($csort){
//			SOY2::import("domain.shop.SOYShop_UserAttribute");
//			$fields = SOYShop_UserAttributeConfig::getIndexFields();
//			if(!in_array($csort, $fields)){
//				$csort = $obj->getCustomSort();
//			}
//
//			return SOYShop_UserDAO::getSortColumnName($csort) . $suffix;
//		}
//
//
//		return null;
...
//    	$this->sort = new SearchUserUtil_SortImpl($sort);
//    }
//}
?>
