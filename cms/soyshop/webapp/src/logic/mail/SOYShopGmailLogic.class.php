...
class SOYShopGmailLogic extends SOY2LogicBase {

	function __construct(){
		SOY2::import("util.SOYShopGmailUtil");
	}
	...
	function sendMail(string $sendTo, string $title, string $body, string $sendToName="", string $from="", string $fromName="", array $replyTo=array()){
		...
		$secretPath = SOYShopGmailUtil::SOYSHOP_GMAIL_API_OAUTH_CLIENT_SECRET_FILEPATH;
		...
		// 認証トークンが見つからない場合は終了
		$tokenPath = SOYShopGmailUtil::SOYSHOP_GMAIL_API_OAUTH_TOKEN_FILEPATH;
