...
class SOYShopPageBase extends WebPage{
	...
	function common_execute(){
		...
		if(!$page instanceof SOYShop_Page) {
			$this->error = new Exception("failed SOYShop_Page Object on SOYShopPageBase");
			return;
		}
	...
	function convertMeta(string $string){
		...
		switch($page->getType()){
			case "list":
				$obj = $page->getObject();
				if(!$obj instanceof SOYShop_ListPage) {
					$this->error = new Exception("failed SOYShop_ListPage Object on SOYShopPageBase");
					break;
				} 
			...
			case "detail":
				$obj = $page->getObject();
				if(!$obj instanceof SOYShop_DetailPage) {
					$this->error = new Exception("failed SOYShop_DetailPage Object on SOYShopPageBase");
					break;
				}
