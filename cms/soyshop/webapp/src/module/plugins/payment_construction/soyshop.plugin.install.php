<?php
class PaymentConstructionInstall extends SOYShopPluginInstallerBase{
...
SOYShopPlugin::extension("soyshop.plugin.install", "payment_construction", "PaymentConstructionInstall");
