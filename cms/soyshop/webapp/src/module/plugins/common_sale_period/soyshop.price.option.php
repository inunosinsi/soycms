...
class SalePeriodPriceOption extends SOYShopPriceOptionBase{
	...
	function getForm(SOYShop_Item $item){
		...
		$html[] = "<input type=\"text\" name=\"" . self::PLUGIN_ID . "_start\" id=\"sale_period_start\" class=\"date_picker_start\" value=\"" . soyshop_convert_date_string($obj->getSalePeriodStart()) . "\" readonly>～";
		$html[] = "<input type=\"text\" name=\"" . self::PLUGIN_ID . "_end\" id=\"sale_period_end\" class=\"date_picker_end\" value=\"" . soyshop_convert_date_string($obj->getSalePeriodEnd()) . "\" readonly>";
