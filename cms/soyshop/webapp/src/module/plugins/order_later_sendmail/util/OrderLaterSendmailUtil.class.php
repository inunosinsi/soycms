...
class OrderLaterSendmailUtil{
	...
	public static function saveConfig($values){
		SOYShop_DataSets::put("order_later_sendmail.config", $values);
	}
	...
	public static function saveMailTitle($title){
		SOYShop_DataSets::put("order_later_sendmail.title", $title);
	}
	...
	public static function saveMailContent($content){
		SOYShop_DataSets::put("order_later_sendmail.content", $content);
	}
}
