...
class PayJpUtil {
	...
	public static function save($key, $value){
		SOY2ActionSession::getUserSession()->setAttribute("payment_pay_jp." . $key, $value);
	}

	public static function get($key){
		return SOY2ActionSession::getUserSession()->getAttribute("payment_pay_jp." . $key);
	}

	public static function clear($key){
		SOY2ActionSession::getUserSession()->setAttribute("payment_pay_jp." . $key, null);
	}
