...
class LoggingBlackCustomerOrderCustomfield extends SOYShopOrderCustomfield{
...
SOYShopPlugin::extension("soyshop.order.customfield", "logging_black_customer", "LoggingBlackCustomerOrderCustomfield");
?>