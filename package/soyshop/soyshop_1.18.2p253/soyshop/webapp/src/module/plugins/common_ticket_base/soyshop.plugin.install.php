<?php
class CommonTicketBaseInstall extends SOYShopPluginInstallerBase{
...
SOYShopPlugin::extension("soyshop.plugin.install", "common_ticket_base", "CommonTicketBaseInstall");
