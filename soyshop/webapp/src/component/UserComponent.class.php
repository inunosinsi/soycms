...
class UserComponent {
	...
	public function buildForm($page, SOYShop_User $user, $app ,$mode = self::MODE_CUSTOM_FORM){
		...
		$placeholderConfig = $this->config->getPlaceholderConfig();
		...
		$page->addInput("mail_address", array(
			...
			"value" => $mailAddress,
			"placeholder" => (isset($placeholderConfig["mailAddress"])) ? $placeholderConfig["mailAddress"] : "",
		...
		$page->addInput("account_id", array(
			...
			"placeholder" => (isset($placeholderConfig["accountId"])) ? $placeholderConfig["accountId"] : "",
			"attr:autocomplete" => "false"
		));
		...
		$page->addInput("name", array(
			"name" => "Customer[name]",
			"value" => $user->getName(),
			"placeholder" => (isset($placeholderConfig["name"])) ? $placeholderConfig["name"] : "",
			"attr:autocomplete" => "false"
		));
		...
		$page->addInput("nickname", array(
			...
			"placeholder" => (isset($placeholderConfig["nickname"])) ? $placeholderConfig["nickname"] : "",
			"attr:autocomplete" => "false"
		));
		...
		//生年月日 年
		$maxYear = date("Y") + $this->config->getBirthdayYearMax();
		$minYear = ((int)$this->config->getBirthdayYearRange() > 0) ? $maxYear - (int)$this->config->getBirthdayYearRange() : 1900;
		...
		$page->addInput("zip_code", array(
			...
			"placeholder" => (isset($placeholderConfig["zipCode"])) ? $placeholderConfig["zipCode"] : "",
			"attr:autocomplete" => "false"
		));
		...
		for($i = 1; $i <= 4; $i++){
			...
			$page->addInput("address" . $i, array(
				...
				"value" => $addrV,
				"placeholder" => (isset($placeholderConfig["address".$i])) ? $placeholderConfig["address".$i] : "",
				"attr:autocomplete" => "false"
			));
		...
		$page->addInput("telephone_number", array(
			...
			"placeholder" => (isset($placeholderConfig["telephoneNumber"])) ? $placeholderConfig["telephoneNumber"] : "",
			"attr:autocomplete" => "false"
		));
		...
		$page->addInput("fax_number", array(
			...
			"placeholder" => (isset($placeholderConfig["faxNumber"])) ? $placeholderConfig["faxNumber"] : "",
			"attr:autocomplete" => "false"
		));
		...
		$page->addInput("cellphone_number", array(
			...
			"placeholder" => (isset($placeholderConfig["cellphoneNumber"])) ? $placeholderConfig["cellphoneNumber"] : "",
			"attr:autocomplete" => "false"
		));
		...
		$page->addInput("url", array(
			"name" => "Customer[url]",
			"value" => $user->getUrl(),
			"placeholder" => (isset($placeholderConfig["url"])) ? $placeholderConfig["url"] : "",
			"attr:autocomplete" => "false"
		));
		...
		$page->addInput("job_name", array(
			...
			"placeholder" => (isset($placeholderConfig["jobName"])) ? $placeholderConfig["jobName"] : "",
			"attr:autocomplete" => "false"
		));
