...
**/
	...
	if(!isset($_GET["y"]) || !isset($_GET["m"])){
		//list($year, $month) = SOY2Logic::createInstance("module.plugins.calendar_expand_smart.logic.Schedule.SmartScheduleLogic")->findLatestScheduleDate($year, $month, $itemId);
	}
