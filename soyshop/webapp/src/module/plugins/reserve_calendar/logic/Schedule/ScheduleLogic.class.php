...
class ScheduleLogic extends SOY2LogicBase{
	 ...
	 * @return array
	 */
	function findLatestScheduleDate(int $year, int $month, int $itemId=0){
		return soyshop_get_hash_table_dao("schedule_calendar")->findLatestScheduleDate($year, $month, $itemId);
	}
