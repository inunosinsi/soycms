...
ALTER TABLE soyshop_item_attribute MODIFY COLUMN item_field_id VARCHAR NOT NULL;
...
ALTER TABLE soyshop_category_attribute MODIFY COLUMN category_field_id VARCHAR NOT NULL;
...
ALTER TABLE soyshop_user_attribute MODIFY COLUMN user_field_id VARCHAR NOT NULL;
