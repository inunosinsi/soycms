...
//			"richtext" => "リッチテキスト",
	...
	function hasOption(){
		return (bool)($this->getType() == SOYShop_OrderAttribute::CUSTOMFIELD_TYPE_RADIO || $this->getType() == SOYShop_OrderAttribute::CUSTOMFIELD_TYPE_SELECT || $this->getType() == SOYShop_OrderAttribute::CUSTOMFIELD_TYPE_CHECKBOX);
	}
	function hasRadioOption(){
		return (bool)($this->getType() == SOYShop_OrderAttribute::CUSTOMFIELD_TYPE_RADIO);
	}
	...
	function hasFileOption(){
		return (bool)($this->getType() == SOYShop_OrderAttribute::CUSTOMFIELD_TYPE_FILE);
	}
