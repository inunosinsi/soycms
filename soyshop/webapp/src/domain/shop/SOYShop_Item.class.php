...
class SOYShop_Item {
	...
	function getDetailPageId() {
		...
		return (is_numeric($this->detailPageId) && is_numeric(soyshop_get_page_object($this->detailPageId)->getId())) ? (int)$this->detailPageId : (int)SOY2Logic::createInstance("logic.site.page.PageLogic")->getOldestDetailPageId();
	}
