...
class SOYShop_ItemAttributeConfig{
	...
	function hasOption(){
		return (bool)($this->getType() == "checkboxes" || $this->getType() == "radio" || $this->getType() == "select");
	}
	function hasExtra(){
		return (bool)($this->getType() == "image");
	}
	...
	function isIndex(){
		return (isset($this->config["isIndex"])) ? (bool)$this->config["isIndex"] : false;
	}
