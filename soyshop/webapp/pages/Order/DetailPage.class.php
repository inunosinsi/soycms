...
class DetailPage extends WebPage{
    ...
    function __construct($args) {
    	...
    	$this->createAdd("user_attribute_list", "_common.User.UserAttributeListComponent", array(
    		"list" => SOYShopPlugin::invoke("soyshop.user.customfield", array("mode" => "order_detail", "userId" => (int)$order->getUserId()))->getList()
    	));
